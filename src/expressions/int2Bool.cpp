...
llvm::Value* ASTExpressionInt2Bool::Compile(llvm::Module& mod, llvm::IRBuilder<>& builder, ASTFunction* func)
{
    ...
    return builder.CreateCmp(llvm::CmpInst::ICMP_NE, operand->CompileRValue(mod, builder, func), llvm::ConstantInt::get(VarTypeSimple::IntType.GetLLVMType(builder.getContext()), 0));
}
